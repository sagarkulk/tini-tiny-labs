...
export default function Feedback() {
	...
	return (
		<div className="feedbackWrap">
			...
			<p className="feedbackSub">
				Send feedback or ask for support. We’ll email you back.
			</p>
			...
			>
				...
				<div className="feedbackRow">
					<div className="feedbackCtrl">
						<label htmlFor={nameId} className="feedbackLabel">
							Your name
						</label>
						<input
							id={nameId}
					...
					<div className="feedbackCtrl">
						<label htmlFor={emailId} className="feedbackLabel">
							Your email
						</label>
						<input
							id={emailId}
				...
				<div className="feedbackCtrl">
					<label htmlFor={msgId} className="feedbackLabel">
						Message
					</label>
					<textarea
						id={msgId}
				...
				<div className="feedbackActions">
					...
					<span
						...
						className={`feedbackMsg ${
							state.ok == null ? "" : state.ok ? "ok" : "err"
						}`}
						style={{ display: state.msg ? "inline-flex" : "none" }}
					>
						{state.ok === true ? "✓" : state.ok === false ? "⚠" : ""}{" "}
						{state.msg}
					</span>
				</div>
			</form>
