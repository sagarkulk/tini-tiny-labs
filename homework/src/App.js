...
import MathematicsV1 from "./components/MathematicsV1";
      ...
      <div className="app-shell">
        <header className="app-header">
          <div className="header-inner">
            ...
            <nav className="nav">
              ...
              <NavLink to="/homework/mathematicsv1">Mathematics V1</NavLink>
        ...
        <main className="app-main">
          <Routes>
            ...
            <Route path="/homework/mathematicsv1" element={<MathematicsV1 />} />
